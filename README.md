...
Intelligent Bistro is a mobile ordering app where users can create orders the regular way and through an AI assistant!

The frontend is built with React Native, and the backend with Node.js.
